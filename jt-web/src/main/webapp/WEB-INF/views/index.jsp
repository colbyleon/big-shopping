...
<head>
    ...
    <title>京淘网上商城-综合网购首选（JD.COM）-正品低价、品质保障、货到付款、配送及时、放心服务、轻松购物！</title>
    <meta name="description"
          content="京淘JD.COM-专业的综合网上购物商城，在线销售家电、数码通讯、电脑、家居百货、服装服饰、母婴、图书、食品、在线旅游等数万个品牌千万种优质商品。便捷、诚信的服务，为您提供愉悦的网上商城购物体验! ">
    ...
    <div id="o-slide">
        ...
        <script type="text/javascript">
            pageConfig.DATA_MScroll = [
                ...
                {
                    "alt": "",
                    "href": "http://www.jt.com/items/1474391965.html",
                    "index": 1,
                ...
                {
                    "alt": "",
                    "href": "http://www.jt.com/items/1474391964.html",
                    "index": 2,
                ...
                <c:forEach items="${news }" var="item" varStatus="status">
                    <c:choose>
                        <c:when test="${status.index % 2 == 0}">
                            <li class="odd" clstag="homepage|keycount|home2013|11b1"><a href="${item.url }"
                                                                                        target="_blank"
                                                                                        title="${item.title }">${item.title }</a>
                            </li>
                        </c:when>
                        <c:otherwise>
                            <li clstag="homepage|keycount|home2013|11b1"><a href="${item.url }" target="_blank"
                                                                            title="${item.title }">${item.title }</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
